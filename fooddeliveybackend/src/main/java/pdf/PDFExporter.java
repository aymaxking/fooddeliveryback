...
public class PDFExporter {
    private ApplicationDeliveryVo application;

    public PDFExporter(ApplicationDeliveryVo application) {
    ...
    private void writeTableData(PdfPTable table) {
            ...
            table.addCell(application.getAdresse());
            table.addCell(application.getCin());
            table.addCell(application.getNumber());
